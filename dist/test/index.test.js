...
import { encodeRoles, decodeRoles, AccessLevel, hasReaderAccess, hasContributorAccess, hasApproverAccess, hasAdministratorAccess, hasSystemAccess, hasSystemAdministratorAccess, isAuthorized } from '../src/index.js';
...
const testAuthorizationFunction = (fn, matchingAccess, nonMatchingAccess) => {
    const userId = 'test_user_id';
...
describe('Test isAuthorized', () => {
    ...
    const roles = [{ userId: 'test_user_id', organizationId, access }];
